...
![État du job après le premier build](tp1_premierbuild.png)
...
![Sortie console du build #1](tp1_resultbuild1.png)
...
![Artefacts archivés](tp2_maven_artefacts.png)
...
![Rapport de tests](tp2_maven_test_results.png)
...
![Console du build Maven](tp2_maven_terminal_results.png)
...
![Push depuis VS Code](tp3-Hw-Ci-gitpush.png)
...
![Build automatique](tp3-Hw-Ci-autobuild.png)
...
![Build #4 en échec](tp4-sonar-errorbuild.png)
...
![Console de l'échec](tp4-sonar-errorbuild-console.png)
...
![Configuration SonarQube dans Jenkins](tp4-sonar-config.png)
...
![Tableau de bord SonarQube](tp4-sonar-success-1.png)
...
![Détail du quality gate](tp4-sonar-success-2.png)
...
![Issues détectées](tp4-sonar-success-3.png)
...
![Build paramétré](tp5-build%20with%20parameter-1.png)
...
![Build #11 en échec](tp6-deploytotomcat-failed.png)
*Figure 15 — Build #11 (commit « webapp and tomcat: WAR ») en échec.*

![Console de l'échec d'archivage](tp6-deploytotomcat-failed-console.png)
...
![No wars found](tp6-deploytotomcat-failed-console2.png)
...
![Configuration erronée](tp6-deploytotomcat-wrong-config.png)
...
![Application déployée](tp6-deploytotomcat-success-webpage.png)
...
![Erreur de pipeline](tp7-jenkins-pipeline-error-console.png)
...
![Configuration du pipeline](tp7-jenkins-pipeline-config.png)
...
![Vue Stages](tp7-jenkins-pipeline-results-stages.png)
...
![Builds en attente](tp8-jenkinsagent-buildQueued.png)
*Figure 23 — Builds #8 terminé et suivants en attente : aucun exécuteur disponible.*

![File d'attente](tp8-jenkinsagent-buildQueued2.png)
...
![Agent offline](tp8-jenkinsagent-offline.png)
*Figure 25 — Console du build #9 : Still waiting to schedule task, l'agent agent-linux est hors ligne.*

![Conteneur arrêté](tp8-jenkinsagent-docker-stopped.png)
...
![Redémarrage de l'agent](tp8-jenkinsagent-restarting.png)
...
![Builds démarrés](tp8-jenkinsagent-online-startBuilds.png)
...
![Configuration ThinBackup](tp9-thinbackup-config.png)
...
![Bind mount des sauvegardes](tp9-thinbackup-bindingVolumeonPC.png)
...
![Sauvegarde externalisée](tp9-thinbackup-externalBackupResult.png)
